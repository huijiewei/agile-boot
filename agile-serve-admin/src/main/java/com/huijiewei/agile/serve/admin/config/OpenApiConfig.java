        ...
        return new OpenAPI()
                ...
                .components(new Components()
                        .addSchemas("DateRangeSearchRequestSchema", new ArraySchema()
                                ...
                                .minItems(2)
                                .maxItems(2))
                        .addSchemas("IdentityLogTypeRequestSchema", defineIdentityLogTypeSearchRequest())
                        ...
                        .addMediaType(org.springframework.http.MediaType.APPLICATION_PROBLEM_JSON_VALUE, new MediaType()
                                .schema(new Schema<>()
                                        ...
                                        .addProperties("title", new Schema<>()
                                                .type("string")
                                                .description("错误标题"))
                                        .addProperties("violations", new ArraySchema()
                                                .items(new Schema<>()
                                                        .addProperties("field", new Schema<>()
                                                                .type("string")
                                                                .description("错误字段"))
                ...
                .content(new Content().
                        addMediaType(org.springframework.http.MediaType.APPLICATION_PROBLEM_JSON_VALUE,
                                new MediaType().schema(new Schema<>()
                                        .type("object")
                                        .addProperties("status", new Schema<>()
                                                .type("integer").description("错误状态"))
                                        .addProperties("title", new Schema<>()
                                                .type("string").description("错误标题"))
                                        .addProperties("detail", new Schema<>()
                                                .type("string").description("错误详情"))
                                )
                        )
                );
    }
